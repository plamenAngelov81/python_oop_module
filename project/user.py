...
#
# class User:
#     FIRST_NAME_MESSAGE = "First name cannot be empty!"
#     LAST_NAME_MESSAGE = "First name cannot be empty!"
#     DRIVING_LICENSE_NUMBER_MESSAGE = "Driving license number is required!"
#     NEGATIVE_RATING_MESSAGE = "Users rating cannot be negative!"
#
...
#         Validator.check_for_empty_strings(value, self.FIRST_NAME_MESSAGE)
...
#         Validator.check_for_empty_strings(value, self.LAST_NAME_MESSAGE)
...
#         Validator.check_for_negative_rating(value, self.NEGATIVE_RATING_MESSAGE)
#         self.__rating = value
#
